...
def generate_cell(init, seed, budgets, dry_run=False):
    ...
    configs = {
        ...
        module_dir / "config.toml": JOINT_TRIGGER_TEMPLATE.format(
            ...
            # unchanged): pinned to 1 here so init stays the only axis varying between this
            # script's two cells -- the 5-checkpoint real test lives in gen_configs.py's own
